...
export default function ProductPage() {
  ...
  const images = [
    "/images/cant/cant_1.jpg",
    "/images/cant/cant_2.jpeg",
    "/images/cant/cant_3.jpeg",
    "/images/cant/cant_4.jpeg",
    "/images/cant/cant_5.jpeg",
  ]
       ...
       <button
          ...
          <div className="flex flex-col space-y-8">
            <div className="space-y-2">
              <h1 className="text-3xl md:text-4xl font-light tracking-tight">Can't Hurt Me</h1>
            ...
            <Button
              ...
              onClick={() => window.open("https://buy.stripe.com/5kQ5kDbWn0KL6VTcB21Jm0g", "_blank")}
            >
              Buy Now
            </Button>
